...
class ClassificationEvaluator(object):
    ...
    def evaluate(self, predicts, standard_label_names=None,
        ...
        f.write("standard_label\tpredict\n")
        for predict in predicts:
            ...
            standard_label_name_str, predict_label_name_str = "", ""
            for i in standard_label_name:
                standard_label_name_str += i+";"
            for i in predict_label_name:
                predict_label_name_str += i+";"
            f.write(standard_label_name_str[:-1]+"\t"+predict_label_name_str[:-1]+"\n")
